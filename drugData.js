...
const POPULAR_COMMERCIAL_DRUGS = [
  ...
  { id: "taxen_400", brandName: "탁센400이부프로펜연질캡슐", company: "GC녹십자", category: "소염진통제 (이부프로펜)", ingredients: [{ name: "이부프로펜", amount: "400mg" }] },
  { id: "taxen_eve", brandName: "탁센이브연질캡슐", company: "GC녹십자", category: "생리통/소염진통제", ingredients: [{ name: "이부프로펜", amount: "200mg" }, { name: "파마브롬", amount: "25mg" }] },
  { id: "taxen_mg", brandName: "탁센엠지연질캡슐", company: "GC녹십자", category: "위장보호 소염진통제", ingredients: [{ name: "이부프로펜", amount: "200mg" }, { name: "메타규산알루민산마그네슘", amount: "100mg" }] },
  { id: "taxen_dexi", brandName: "탁센덱시연질캡슐", company: "GC녹십자", category: "소염진통제 (덱시부프로펜)", ingredients: [{ name: "덱시부프로펜", amount: "300mg" }] },
  { id: "taxen_lady", brandName: "탁센레이디연질캡슐", company: "GC녹십자", category: "생리통 진통제", ingredients: [{ name: "이부프로펜", amount: "200mg" }, { name: "파마브롬", amount: "25mg" }, { name: "산화마그네슘", amount: "50mg" }] },
  { id: "taxen_ace", brandName: "탁센아세트아미노펜정500mg", company: "GC녹십자", category: "해열진통제", ingredients: [{ name: "아세트아미노펜", amount: "500mg" }] },
